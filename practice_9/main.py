...
def trim_image(image):
    ...
    return cropped
sec_hand = pygame.image.load("practice_9/images/Mickey_handleft.png").convert_alpha()
min_hand = pygame.image.load("practice_9/images/Mickey_hand.png").convert_alpha()
